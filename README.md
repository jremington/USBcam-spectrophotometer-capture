...
4. Interactive options: click on the "frameROI" window to bring it into focus.
   ...
   * Typing "u" or "d" increases/decreases exposure setting by one stop (one power of two). Contrary to the documentation, 32 second exposures are practical in low light situations.
